...
function prepareAppBucketTree() {
  $('#appBuckets').jstree({
    ...
    if (!extensionloaded) {
      ...
      if (extension) {
        document.getElementById('dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bHRnNnNvY2l3amhrd2pxMXV2OHBsOXhlZnFuaXJ3a3YtYmFzaWMtYXBwL3JhY2Jhc2ljc2FtcGxlcHJvamVjdC5ydnQ=_anchor').click();
